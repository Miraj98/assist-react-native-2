import { GET_CAPTIONS, GET_CAPTIONS_FAIL, GET_CAPTIONS_SUCCESS, AUTH_TOKEN, USER_EMAIL } from '../actionTypes'
...
export const requestCaptionsFromApi = () => ((dispatch, getState) => {
    ...
    const REQUEST_URL = 'https://getassist.app:8080/posts/pagedpostcaptionfeed/' + USER_EMAIL + '/0/-1'
